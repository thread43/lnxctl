...
func GetPvcs(response http.ResponseWriter, request *http.Request) {
	var err error
	...
	var pvc_list *core_v1.PersistentVolumeClaimList
	...
	for _, item = range pvc_list.Items {
		...
		// Pending|Bound|Lost
		var status core_v1.PersistentVolumeClaimPhase
