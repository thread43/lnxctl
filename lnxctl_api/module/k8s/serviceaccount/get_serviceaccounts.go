...
func GetServiceaccounts(response http.ResponseWriter, request *http.Request) {
	var err error
	...
	var serviceaccount_list *core_v1.ServiceAccountList
	...
	util.Api(response, 200, serviceaccounts)
}
