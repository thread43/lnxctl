      ...
      render: (text, record) => (
        record.parent_menu_id === 0 ? text : (
          <span>
            ...
            {/* <EnterOutlined style={{transform: 'scaleX(-1)', verticalAlign: 'top'}} /> */}
            {/* <EnterOutlined style={{transform: 'scaleX(-1)', position: 'relative', top: '-3px'}} /> */}
            <EnterOutlined style={{transform: 'scaleX(-1) translateY(-3px)'}} />
            &nbsp;&nbsp;
            {text}
          </span>
        )
