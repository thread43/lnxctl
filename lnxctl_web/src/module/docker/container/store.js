...
const containerSlice = createSlice({
  ...
  reducers: {
    ...
    setContainerJsonVisible: (state, action) => {state.containerJsonVisible = action.payload;},
...
const getContainerJsonVisible = (state) => state.dockerContainer.containerJsonVisible;
...
const {setContainerJsonVisible} = containerSlice.actions;
