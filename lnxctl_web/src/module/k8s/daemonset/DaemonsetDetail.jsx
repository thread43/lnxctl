    ...
    <>
      <Modal
        ...
        footer={[
          <Button
            key="close"
            onClick={() => dispatch(store.setDaemonsetDetailVisible(false))}
          >
            Close
          </Button>,
        ]}
      >
        ...
        >
          <Form.Item label="Namespace">
            {storeDaemonset.namespace}
          </Form.Item>
          <Form.Item label="Name">
            {storeDaemonset.name}
          </Form.Item>
          <Form.Item label="Desired">
            {storeDaemonset.desired_number_scheduled}
          </Form.Item>
          <Form.Item label="Current">
            {storeDaemonset.current_number_scheduled}
          </Form.Item>
          <Form.Item label="Ready">
            {storeDaemonset.number_ready}
          </Form.Item>
          <Form.Item label="Up To Date">
            {storeDaemonset.updated_number_scheduled}
          </Form.Item>
          <Form.Item label="Available">
            {storeDaemonset.number_available}
          </Form.Item>
          ...
          <Form.Item label="Containers">
            {(storeDaemonset.containers !== null) && (
              storeDaemonset.containers.map((item, index) => (
                <span key={index}>
                  <div style={{whiteSpace: 'normal', wordBreak: 'break-all'}}>
