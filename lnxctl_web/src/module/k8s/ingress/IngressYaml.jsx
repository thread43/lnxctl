...
function IngressYaml() {
  ...
  async function init() {
    try {
      const ingress = storeIngress;

      setStateLoading(true);

      const response = await api.get_ingress_yaml(ingress);
      ...
      >
        <div className="MyContentHeader">
          <span className="MyContentHeaderTitle">
            {storeIngress.namespace} / {storeIngress.name}
          </span>
          <Space>
