    ...
    <>
      ...
      >
        <Form layout="horizontal" labelCol={{span: 9}} wrapperCol={{span: 12}} className="MyForm">
          ...
          <Form.Item label="Age">{storeNode.age}</Form.Item>
          <Form.Item label="Version">{storeNode.version}</Form.Item>
          ...
          <Form.Item label="Memory (GB)">{storeNode.memory2}</Form.Item>
          <Form.Item label="Storage (GB)">{storeNode.storage2}</Form.Item>
