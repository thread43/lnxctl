    ...
    <>
      <Modal
        ...
        footer={[
          <Button
            key="close"
            onClick={() => dispatch(store.setRolebindingDetailVisible(false))}
          >
            Close
          </Button>,
        ]}
      >
        ...
        >
          ...
          <Form.Item label="Users">
            {storeRolebinding.users.map((item, index) => (
              <div key={index}>{item}</div>
            ))}
          </Form.Item>
          <Form.Item label="Groups">
            {storeRolebinding.groups.map((item, index) => (
              <div key={index}>{item}</div>
            ))}
          </Form.Item>
          <Form.Item label="ServiceAccounts">
            {storeRolebinding.serviceaccounts.map((item, index) => (
              <div key={index}>{item}</div>
            ))}
          </Form.Item>
        </Form>
