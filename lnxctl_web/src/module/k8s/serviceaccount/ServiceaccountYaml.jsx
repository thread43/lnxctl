...
function ServiceaccountYaml() {
  ...
  async function init() {
    try {
      const serviceaccount = storeServiceaccount;

      setStateLoading(true);

      const response = await api.get_serviceaccount_yaml(serviceaccount);
  ...
  return (
    <>
      <Modal
        ...
        width={1000}
        open={storeServiceaccountYamlVisible}
      ...
      >
        <div className="MyContentHeader">
          <span className="MyContentHeaderTitle">
            {storeServiceaccount.namespace} / {storeServiceaccount.name}
          </span>
          <Space>
...
export default ServiceaccountYaml;
