...
function StorageclassYaml() {
  ...
  async function init() {
    try {
      const storageclass = storeStorageclass;

      setStateLoading(true);

      const response = await api.get_storageclass_yaml(storageclass);
  ...
  return (
    <>
      <Modal
        ...
        width={1000}
        open={storeStorageclassYamlVisible}
